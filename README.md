...
efficiency_crosscheck     % our model vs MEASURED efficiency (andrew method)
...
stack — motor+inverter (MEASURED from data & andrew's method) × gearbox × bearings
...
verify_math.m            37 independent checks
lib/                     shared physics (motor eff, tyre mu, peak torque, RC battery model)
analysis/                measured-efficiency-map tools (andrew method)
