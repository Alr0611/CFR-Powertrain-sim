...
fprintf('\n');
fprintf('    accel_model_tc            accel WITH traction control + gain sweep\n');
fprintf('    sweep_accel_tc_sim        TC sweep: ratio x gain, one page per torque map\n');
fprintf('\n');
fprintf('  more:\n');
...
fprintf('\n');
fprintf('  Simulink (three models, different jobs):\n');
fprintf('    open_system(''accel_sim'')            baseline accel, no TC\n');
fprintf('    open_system(''accel_tc_sim'')         one TC run, one ratio, one map\n');
fprintf('    open_system(''accel_tc_sweep_sim'')   the one sweep_accel_tc_sim drives\n');
fprintf('    rebuild with build_accel_simulink / build_accel_tc_simulink /\n');
fprintf('                 build_accel_tc_sweep_simulink after changing params\n');
fprintf('\n');
