...
fprintf('    verify_math               46 checks that recompute everything from scratch\n');
fprintf('\n');
fprintf('  more:\n');
fprintf('    degradation_study         how worn are the 2018 motor/inverter? (band + how to measure)\n');
...
fprintf('    efficiency_crosscheck     our model vs MEASURED efficiency (af/dteff method)\n');
fprintf('    gear_check                will the new gears survive? (needs drawing numbers)\n');
